#!/usr/bin/env python3
"""
Display All Transcripts Analysis Results
Show summary statistics and open the 3D visualization with all transcripts
"""
...
def display_results():
    """Display summary of all-transcripts analysis results"""
    print("🎯 All Transcripts 3D Visualization Results")
    print("=" * 60)
    
    # Load the data
    data_file = Path("xenium_all_transcripts_analysis/all_transcripts_data.csv")
    ...
    html_file = Path("xenium_all_transcripts_analysis/all_transcripts_3d_visualization.html")
    if html_file.exists():
        print(f"\n📁 Generated Files:")
        ...
        print(f"   - ALL transcripts included (no filtering)")
        print(f"   - Expression intensity based on local transcript density")
    else:
